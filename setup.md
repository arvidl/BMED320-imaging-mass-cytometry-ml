Copyright (c) 2020 Computational-Medicine  (BMED320 IMC-ML project)
...
```bash
git clone https://github.com/arvidl/BMED320-imaging-mass-cytometry-ml
cd BMED320-imaging-mass-cytometry-ml
```
...
```bash
python -m ipykernel install --user --name imc --display-name "IMC"
```
